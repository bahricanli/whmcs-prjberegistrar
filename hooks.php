<?php
/**
 * WHMCS SDK Prjbe Registrar Module Hooks File
 *
...
add_hook('AdminHomeWidgets', 1, function() {
    return new PrjbeRegistrarModuleWidget();
});

/**
 * Prjbe Registrar Module Admin Dashboard Widget.
 *
 * @see https://developers.whmcs.com/addon-modules/admin-dashboard-widgets/
 */
class PrjbeRegistrarModuleWidget extends \WHMCS\Module\AbstractWidget
{
    protected $title = 'Prj.Be Registrar';
