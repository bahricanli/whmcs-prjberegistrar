<?php
/**
 * WHMCS SDK Prj.Be Registrar Module
 *
 ...
 * function begin "prjberegistrar_".
 *
...
require_once __DIR__ . '/lib/PrjBeRegistryApiClient.php';

use WHMCS\Domains\DomainLookup\ResultsList;
use WHMCS\Domains\DomainLookup\SearchResult;
use WHMCS\Module\Registrar\Registrarmodule\ApiClient;
use PrjBeRegistry\PrjBeRegistryApiClient;
 ...
 * @return array
 */
function prjberegistrar_MetaData()
{
    return array(
        'DisplayName' => 'Prj.Be Registrar',
        'APIVersion' => '1.0',
    );
}
 ...
 * @return array
 */
function prjberegistrar_getConfigArray()
{

    error_log("prjberegistrar_getConfigArray");

    return [
        // Friendly display name for the module
        'FriendlyName' => [
            'Type' => 'System',
            'Value' => 'Prj.Be Registrar Module',
        ],
 ...
 * @return array
 */
function prjberegistrar_RegisterDomain($params)
{

    error_log("prjberegistrar_RegisterDomain");
    ...
    try {
        $api = new PrjBeRegistryApiClient();
 ...
 * @return array
 */
function prjberegistrar_TransferDomain($params)
{

    error_log("prjberegistrar_TransferDomain");
 ...
 * @return array
 */
function prjberegistrar_RenewDomain($params)
{

    error_log("prjberegistrar_RenewDomain");
 ...
 * @return array
 */
function prjberegistrar_GetNameservers($params)
{

    error_log("prjberegistrar_GetNameservers");
 ...
 * @return array
 */
function prjberegistrar_SaveNameservers($params)
{

    error_log("prjberegistrar_SaveNameservers");
 ...
 * @return array
 */
function prjberegistrar_GetContactDetails($params)
{

    error_log("prjberegistrar_GetContactDetails");
 ...
 * @return array
 */
function prjberegistrar_SaveContactDetails($params)
{

    error_log("prjberegistrar_SaveContactDetails");
 ...
 */
function prjberegistrar_CheckAvailability($params)
{

    error_log("prjberegistrar_CheckAvailability");
 ...
 */
function prjberegistrar_DomainSuggestionOptions() {
    return array(
        'includeCCTlds' => array(
 ...
 * @return \WHMCS\Domains\DomainLookup\ResultsList An ArrayObject based collection of \WHMCS\Domains\DomainLookup\SearchResult results
 */
function prjberegistrar_GetDomainSuggestions($params)
{

    error_log("prjberegistrar_GetDomainSuggestions");
 ...
 */
function prjberegistrar_GetRegistrarLock($params)
{

    error_log("prjberegistrar_GetRegistrarLock");
 ...
 * @return array
 */
function prjberegistrar_SaveRegistrarLock($params)
{

    error_log("prjberegistrar_SaveRegistrarLock");
 ...
 */
function prjberegistrar_GetDNS($params)
{

    error_log("prjberegistrar_GetDNS");
 ...
 * @return array
 */
function prjberegistrar_SaveDNS($params)
{

    error_log("prjberegistrar_SaveDNS");
 ...
 * @return array
 */
function prjberegistrar_IDProtectToggle($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 *
 */
function prjberegistrar_GetEPPCode($params)
{

    error_log("prjberegistrar_GetEPPCode");
 ...
 * @return array
 */
function prjberegistrar_ReleaseDomain($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function prjberegistrar_RequestDelete($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 * @return array
 */
function prjberegistrar_RegisterNameserver($params)
{

    error_log("prjberegistrar_RegisterNameserver");
 ...
 * @return array
 */
function prjberegistrar_ModifyNameserver($params)
{

    error_log("prjberegistrar_ModifyNameserver");
 ...
 * @return array
 */
function prjberegistrar_DeleteNameserver($params)
{

    error_log("prjberegistrar_DeleteNameserver");
 ...
 * @return array
 */
function prjberegistrar_Sync($params)
{

    error_log("prjberegistrar_Sync");
 ...
 * @return array
 */
function prjberegistrar_TransferSync($params)
{

    error_log("prjberegistrar_TransferSync");
 ...
 * the `prjberegistrar_push` function when invoked.
 *
 * @return array
 */
function prjberegistrar_ClientAreaCustomButtonArray()
{
    return array(
        'Push Domain' => 'push',
    );
 ...
 * @return array
 */
function prjberegistrar_ClientAreaAllowedFunctions()
{
    return array(
        'Push Domain' => 'push',
    );
 ...
 * @return array
 */
function prjberegistrar_push($params)
{
    // user defined configuration values
    $userIdentifier = $params['APIUsername'];
    $apiKey = $params['APIKey'];
 ...
 */
function prjberegistrar_ClientArea($params)
{
    $output = '
